...
class AttentionLayer(nn.Module):
    def __init__(self, embed_size, h, drop, is_share):
...
class FeedForward(nn.Module):
    def __init__(self, embed_size, hidden, drop):
...
class SelfAttention(nn.Module):
    def __init__(self, embed_size, hid_size, h, drop):
        super(SelfAttention, self).__init__()
        self.h = h
        self.att_layer = AttentionLayer(embed_size, h, drop=drop, is_share=True)
